...
const KidScreen = ({ navigation }) => {
  ...
  const handleContinue = async () => {
    ...
    try {
      await setItem("Kid", selectedKid);
      console.log("✅ Kid Preferrence stored successfully:", selectedKid);
      navigation.navigate('NextScreen', { education: selectedKid });
    } catch (error) {
      console.error("❌ Error saving Kid Preferrences:", error);
    }
  };
