...
//       {/* Top Image with Wave Shape */}
//       <View style={styles.imageWrapper}>
//         <Svg height="250" width="100%" style={styles.svg}>
//           <Defs>
//             <ClipPath id="clip">
//               <Path
//                 d="M0 0 H400 V200 C300 250,100 150,0 250 Z"
//                 fill="black"
//               />
//             </ClipPath>
//           </Defs>
...
//         <View style={[styles.circle, { top: 40, right: 80, backgroundColor: "#FF6B6B" }]}>
//           <Text style={styles.icon}>❝</Text>
//         </View>
//         <View style={[styles.circle, { top: 80, right: 30, backgroundColor: "#4DD0E1" }]}>
//           <Text style={styles.icon}>✎</Text>
//         </View>
//       </View>
